...
int ObProcedureAssginStmt::add_var_val(ObVarAssignVal &var_val)
{
	return var_val_list_.push_back(var_val);
}

ObArray<ObVarAssignVal>& ObProcedureAssginStmt::get_var_val_list()
{
	return var_val_list_;
}

ObVarAssignVal& ObProcedureAssginStmt::get_var_val(int64_t index)
{
